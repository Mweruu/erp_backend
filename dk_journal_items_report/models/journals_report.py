...
class JournalsReport(models.Model):
    ...
    def get_journals(self):
        ...
        journal = self.env['account.journal'].search([('id', '=', self.journal_type)])
    ...
    def action_print_journal_items_report(self):
        ...
        return self.env.ref('dk_journal_items_report.journal_items_report').with_context(landscape=True).report_action(
            None,
            data=report_data)
