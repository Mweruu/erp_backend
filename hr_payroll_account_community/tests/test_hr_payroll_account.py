...
class TestHrPayrollAccount(common.TransactionCase):
    ...
    def test_00_hr_payslip(self):
        ...
        context = {"lang": "en_US", "tz": False, "active_model": 'hr.payslip', "department_id": False,
                   "active_ids": [self.payslip_action_id], "section_id": False, "active_id": self.payslip_action_id}
