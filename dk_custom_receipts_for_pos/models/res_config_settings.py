...
class ResConfigSettings(models.TransientModel):
    ...
    pos_toggle_sign = fields.Boolean(related='pos_config_id.toggle_sign', readonly=False, store=True)
    pos_view_quotation_order = fields.Boolean(related='pos_config_id.view_quotation_order', readonly=False, store=True)
    pos_view_enter_code = fields.Boolean(related='pos_config_id.view_enter_code', readonly=False, store=True)
    pos_set_percentage_range = fields.Float(related='pos_config_id.set_percentage_range', readonly=False,
                                            store=True)
    pos_set_percentage_range_bool = fields.Boolean(related='pos_config_id.set_percentage_range_bool', readonly=False,
                                                   store=True)
