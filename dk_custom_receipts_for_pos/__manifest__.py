...

{
    ...
    'depends': ['base', 'point_of_sale', 'pos_loyalty', 'pos_sale_loyalty', 'loyalty'],
    'data': [
    ...
    'assets': {
        'point_of_sale.assets': [
            'dk_custom_receipts_for_pos/static/src/js/**/*.js',
            'dk_custom_receipts_for_pos/static/src/xml/**/*.xml'
        ],
    },
