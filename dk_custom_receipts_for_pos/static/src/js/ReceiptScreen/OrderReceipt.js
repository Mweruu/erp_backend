odoo.define('dk_custom_receipts_for_pos.receipt',function(require){
    "use strict"
    ...
    const RTDelReprintReceiptScreen = require('dk_custom_receipts_for_pos.RTDelReprintReceiptScreen')
