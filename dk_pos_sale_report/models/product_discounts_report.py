...
class ProductDiscountsReport(models.Model):
    ...
    def action_print_base_price_report(self):
        ...
        return self.env.ref('dk_pos_sale_report.product_discounts_report').report_action(None, data=report_data)
...
class BasePriceReport(models.Model):
    ...
    _description = "base price report"
    ...
    def action_print_base_price_report(self):
        ...
        return self.env.ref('dk_pos_sale_report.base_price_report').report_action(None, data=report_data)
