...
class SaleWorkflowProcess(models.Model):
    ...
    order_filter_id = fields.Many2one(
        ...
        default=lambda self: self._default_filter(
            "dk_sale_automatic_workflow.automatic_workflow_order_filter"
        ),
    )
    picking_filter_id = fields.Many2one(
        ...
        default=lambda self: self._default_filter(
            "dk_sale_automatic_workflow.automatic_workflow_picking_filter"
        ),
    )
    create_invoice_filter_id = fields.Many2one(
        ...
        default=lambda self: self._default_filter(
            "dk_sale_automatic_workflow.automatic_workflow_create_invoice_filter"
        ),
    )
    validate_invoice_filter_id = fields.Many2one(
        ...
        default=lambda self: self._default_filter(
            "dk_sale_automatic_workflow." "automatic_workflow_validate_invoice_filter"
        ),
    )
    sale_done_filter_id = fields.Many2one(
        ...
        default=lambda self: self._default_filter(
            "dk_sale_automatic_workflow.automatic_workflow_sale_done_filter"
        ),
    )
    payment_filter_id = fields.Many2one(
        ...
        default=lambda self: self._default_filter(
            "dk_sale_automatic_workflow.automatic_workflow_payment_filter"
        ),
    )
