...
{
	"name" : "POS Order Return With Barcode Scanner in Odoo Point of Sale Exchange Order",
	"version" : "15.0.0.1",
	"category" : "Point of Sale",
	'summary': 'return product from POS screen return order from POS screen pos return order pos rma order Product Return In POS Exchange POS Order Exchange Return pos refund order pos order return pos item return  ',
...
point of sale Revise Order using barcode scanner point of sale Product Return using barcode scanner.
	...
	'assets': {
        'point_of_sale.assets': [
            "bi_pos_return_order/static/src/js/Popups/ReturnOrderPopup.js",
			"bi_pos_return_order/static/src/js/Screens/ControlButton.js",
			"bi_pos_return_order/static/src/js/Screens/POSOrdersScreen.js",
			"bi_pos_return_order/static/src/js/Screens/TicketScreen.js",
			"bi_pos_return_order/static/src/js/models.js",
        ],
        'web.assets_qweb': [
            'bi_pos_return_order/static/src/xml/**/*',
        ],
    },
