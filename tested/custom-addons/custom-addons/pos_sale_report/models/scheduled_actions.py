...
class ScheduledActions(models.Model):
    ...
    def _cron_send_reports(self):
        ...
        purchase_kpurchase_wizard = self.env['purchase.kpurchase.wizard'].create({})
        report5 = purchase_kpurchase_wizard.get_kpurchase_report_data()
        ...
        pdfs = [
            ...
            self.env.ref('kpartnerfleet.k_purchase_orders_transactions_report')._render(
                'kpartnerfleet.k_purchase_orders_transactions_report_template', report5),
        ...
        templates = [
            ...
            self.env.ref('kpartnerfleet.k_purchase_orders_transactions_report_template').name,
        ...
        names = [
            ...
            self.env.ref('kpartnerfleet.k_purchase_orders_transactions_report').name,
