DROP FUNCTION if EXISTS public.si_ledger_get_stock_data(integer[], integer[], integer[], integer[], text, date, date);
CREATE OR REPLACE FUNCTION public.si_ledger_get_stock_data(
