...
class SetuInventoryLedger(models.TransientModel):
    ...
    def download_report_in_listview(self):
        ...
        tree_view_id_cmpwise = self.env.ref(
            'setu_inventory_ledger_report.setu_inventory_ledger_bi_report_tree_cmpwise').id
        form_view_id = self.env.ref('setu_inventory_ledger_report.setu_inventory_ledger_bi_report_form').id
        search_view = self.env.ref(
            'setu_inventory_ledger_report.setu_inventory_ledger_bi_report_searchview_for_company').id if self.report_by == 'company_wise' else self.env.ref(
...
class SetuInventoryLedgerBIReport(models.TransientModel):
    ...
    _description = 'SetuInventoryLedgerBIReport'
